...
**Histórico da skill:** o resumo curado das R-XXXX está acima, em
`references/apex-test-loop-recommendations.md`. O ledger detalhado
(`.claude/skills/apex-test-loop/RECOMMENDATIONS.md`) é **local** — criado no seu projeto
na primeira fricção real, nunca versionado.
